...
/**
 * Extend the base Actor class to implement additional logic specialized for dh.
 */
class ActorWfrp4e extends Actor {
    ...
    prepareData(actorData) {
      ...
      {
       data.data.status.encumbrance.max = (data.data.characteristics.t.bonus + data.data.characteristics.s.bonus) * 5;
      }
    ...
    setupCharacteristic(characteristicId) {
      ...
      let cardOptions = {
        ...
        title: title,
        template : "systems/dh/templates/chat/characteristic-card.html",
    ...
    setupSkill(skill, income = false) {
      ...
      let cardOptions = {
        ...
        title: title,
        template : "systems/dh/templates/chat/skill-card.html",
        flags : {img: this.data.img}
      }
      if (this.token)
      {
    ...
    setupWeapon(weapon, event) {
      ...
      let cardOptions = {
        ...
        title: title,
        template : "systems/dh/templates/chat/weapon-card.html",
        flags : {img: this.data.img}
      }
      if (this.token)
      {
    ...
    setupCast(spell) {
      ...
      let cardOptions = {
        ...
        title: title,
        template : "systems/dh/templates/chat/spell-card.html",
        flags : {img: this.data.img}
      }
      if (this.token)
      {
   ...
   /**
    ...
    setupChannell(spell) {
      ...
      let cardOptions = {
        ...
        title: title,
        template : "systems/dh/templates/chat/channell-card.html",
        flags : {img: this.data.img}
    ...
    setupPrayer(prayer) {
      ...
      let cardOptions = {
        ...
        title: title,
        template : "systems/dh/templates/chat/prayer-card.html",
        flags : {img: this.data.img}
      }
      if (this.token)
      {
    ...
    setupTrait(trait) {
      ...
      let cardOptions = {
        ...
        title: title,
        template : "systems/dh/templates/chat/skill-card.html", // Reuse skill card
        flags : {img: this.data.img}
      }
      if (this.token)
      {
