class GeneratorWfrp4e
{
  static speciesStage()
  {
    ...
    renderTemplate("systems/dh/templates/chat/chargen/species-select.html", {species : CONFIG.species}).then(html => {
  ...
  static async rollCareer(species)
  {
    ...
    renderTemplate("systems/dh/templates/chat/chargen/career-select.html", {exp : CONFIG.randomExp.careerRand}).then(html => {
      chatData.content = html;
      ChatMessage.create(chatData);
    })
  }
