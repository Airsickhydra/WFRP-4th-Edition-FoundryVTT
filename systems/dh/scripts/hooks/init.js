Hooks.once("init", () => {
    ...
    // })
    FilePicker.browse("user", "systems/dh/tables").then(resp => {
      try 
      {
      if (resp.error)
        throw ""
      ...
      for (data of records)
  {
    ...
    game.settings.register("dh", "initiativeRule", {
    ...
    function _setdhInitiative(initMethod)
    {
     ...
     game.settings.register("dh", "capAdvantageIB", {
    ...
    game.settings.register("dh", "fastSL", {
      name: "Fast SL",
    ...
    game.settings.register("dh", "testAbove100", {
    ...
    game.settings.register("dh", "criticalsFumblesOnAllTests", {
      ...
      game.settings.register("dh", "extendedTests", {
      ...
      game.settings.register("dh", "testAutoFill", {
      ...
      game.settings.register("dh", "npcSpeciesCharacteristics", {
      ...
      game.settings.register("dh", "partialChannelling", {
      ...
      game.settings.register("dh", "displayRoundSummary", {
      ...
      // Register Status on Turn Start
      game.settings.register("dh", "statusOnTurnStart", {
      ...
      game.settings.register("dh", "focusOnTurnStart", {
      ...
      game.settings.register("dh", "hideTestData", {
        name: "Hide Test Data",
      ...
      game.settings.register("dh", "manualChatCards", {
    ...
    // Pre-load templates
    loadTemplates([
      "systems/dh/templates/actors/actor-attributes.html",
      "systems/dh/templates/actors/actor-abilities.html",
      "systems/dh/templates/actors/actor-main.html",
      "systems/dh/templates/actors/actor-combat.html",
      "systems/dh/templates/actors/actor-biography.html",
      "systems/dh/templates/actors/actor-inventory.html",
      "systems/dh/templates/actors/actor-skills.html",
      "systems/dh/templates/actors/actor-magic.html",
      "systems/dh/templates/actors/actor-religion.html",
      "systems/dh/templates/actors/actor-talents.html",
      "systems/dh/templates/actors/actor-classes.html",
      "systems/dh/templates/actors/actor-notes.html",
      "systems/dh/templates/actors/npc-main.html",
      "systems/dh/templates/actors/npc-notes.html",
      "systems/dh/templates/actors/creature-main.html",
      "systems/dh/templates/actors/creature-notes.html",
      "systems/dh/templates/actors/creature-main.html",
      "systems/dh/templates/chat/dialog-constant.html",
      "systems/dh/templates/chat/test-card.html",
      "systems/dh/templates/items/item-header.html",
      "systems/dh/templates/items/item-description.html",
    ]);
  });